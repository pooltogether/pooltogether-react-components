...
export const DEFAULT_INPUT_CLASSES =
  'w-full py-2 px-5 sm:py-4 sm:px-10 text-inverse bg-transparent trans focus:outline-none leading-none'
export const DEFAULT_INPUT_LABEL_CLASSES = 'mt-0 mb-1 text-xs sm:text-sm'
export const DEFAULT_INPUT_GROUP_CLASSES = 'trans bg-body'

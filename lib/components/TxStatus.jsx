...
export const TxStatus = props => {
  ...
  const pleaseConfirmInWalletText = t ? t('pleaseConfirmInYourWallet') : 'Please confirm in your wallet'
  const transactionSentConfirmingText = t ? t('transactionSentConfirming') : 'Transaction confirming ...'
  ...
  const transactionsMayTakeAFewMinutesText = t ? t('transactionsMayTakeAFewMinutes') : 'Transactions may take a few minutes.'
